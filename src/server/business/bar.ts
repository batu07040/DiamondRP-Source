      ...
      bar.list.forEach(function (item) {
          ...
          switch (item[3]) {
              case 49:
                  ...
                  break;
              case 53:
                  methods.createBlip(shopPos, 614, 0, 0.8, 'Kulüp');
                  break;
              case 80:
                  methods.createBlip(shopPos, 102, 0, 0.8, 'Komedi Kulübü');
                  break;
              case 122:
                  methods.createBlip(new mp.Vector3(4.723007, 220.3487, 106.7251), 614, 0, 0.8, 'Kulüp');
                  break;
              default:
                  if (item[3] != 0)
          ...
          methods.createStaticCheckpoint(shopPos.x, shopPos.y, shopPos.z, "Çubuk menüsünü açmak için ~g~E~s~ tuşlarına basın");
      });
