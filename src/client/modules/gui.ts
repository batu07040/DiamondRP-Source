...
const gui = {
  ...
  setGui: (guiName: string) => {
    ...
    mp.console.logWarning(gui.currentGui);
...
mp.events.add('render', () => {
  ...
  if (mp.game.controls.isDisabledControlJustReleased(2, 200)) {
    if (['azs', 'license', 'police_bage', 'quests', 'npc', 'casino', 'chest_equip', 'inventory', 'phone', 'tablet', 'atm', 'autosale'].includes(gui.currentGui)) {
