...
let enums = {
  ...
  lscNames: [
    ...
    ['72', 0],
    ['73', 0],
    ['Gösterge paneli rengi', 1000],
    ['Sonlandırma rengi', 2500],
    ['Özel renklendirme', 2500],
    ['Tekerlek tipi', 0],
    ['Tekerlek tipi', 0],
    ['Tork', 5000],
  ],
  ...
  lscSNames: [
    ...
    ['Motor gücü', 150000],
    ['Frenleme kuvveti', 50],
    ['Fren gücü dağılımı.', 50],
    ['El Freni', 50],
    ['Tekerlek direksiyon açısı', 200],
    ['Dönerken tekerleklerin kavranması', 50],
    ['Tekerlek kayması', 50],
  ],
  ...
  animActions: [
    ['Ellerinizi kaldırın', 'random@mugging3', 'handsup_standing_base', 49],
    [
      'Radyoda bir şey geçiyor',
      'random@arrests',
    ...
    ['İhbarcılık', 'taxi_hail', 'fp_hail_taxi', 8],
    ['Asker selamı verin', 'anim@mp_player_intincarsalutestd@ds@', 'idle_a', 8],
    ['Parmakla işaret etmek', 'gestures@m@standing@casual', 'gesture_point', 8],
    ['Katılıyorum-1', 'gestures@m@standing@casual', 'gesture_i_will', 8],
    ['Katılıyorum-2', 'gestures@m@standing@fat', 'gesture_bye_soft', 8],
    ['Çöp-1', 'gestures@m@standing@casual', 'gesture_nod_no_hard', 8],
    ['Çöp-2', 'gestures@m@standing@casual', 'gesture_no_way', 8],
    ['Çöp-3', 'amb@code_human_in_car_mp_actions@nod@bodhi@ds@base', 'nod_no_fp', 8],
    ['Omuz silkme', 'gestures@m@standing@casual', 'gesture_what_soft', 8],
    ['Ağzına bir şey koy', 'mp_player_int_uppersmoke', 'mp_player_int_smoke_enter', 8],
    ['İçeri girin', 'move_m@drunk@transitions', 'slightly_to_idle', 8],
    ['Knock', 'amb@code_human_in_car_mp_actions@dance@bodhi@ps@base', 'idle_a_fp', 8],
    ['Yatan birine vurmak', 'anim@heists@ornate_bank@hostages@hit', 'player_melee_long_pistol_a', 8],
    ['Tekmeleme', 'anim@mp_freemode_return@f@fail', 'fail_a', 8],
    ['Ellerini sallayarak', 'random@car_thief@victimpoints_ig_3', 'arms_waving', 8],
    ['Uzaklaşın-1', 'taxi_hail', 'forget_it', 8],
    ['Uzaklaşın-2', 'anim@mp_freemode_return@f@idle', 'idle_b', 8],
    ['Yerden kaldırın', 'random@mugging4', 'pickup_low', 8],
    ['Araziyi inceleyin', 'amb@code_human_police_investigate@idle_b', 'idle_f', 8],
    ['Toprağı kazmak', 'amb@world_human_bum_wash@male@high@idle_a', 'idle_a', 8],
    ['Karnından tutт', 'rcmpaparazzo1', 'idle', 8],
    ['Kıçımı kaşıyorum.', 'anim@heists@team_respawn@respawn_02', 'heist_spawn_02_ped_d', 8],
    ['Dua et.', 'pro_mcs_7_concat-0', 'cs_priest_dual-0', 8],
    ['Selam ver-1', 'anim@mp_player_intcelebrationpaired@f_f_sarcastic', 'sarcastic_right', 8],
    ['Selam ver-2', 'anim@mp_player_intcelebrationpaired@m_m_sarcastic', 'sarcastic_left', 8],
    ['Geri itin', 'amb@world_human_push_ups@male@base', 'base', 8],
    ['Karın kaslarınızı çalıştırın', 'amb@world_human_sit_ups@male@base', 'base', 8],
    ['Nefes al', 'timetable@reunited@ig_2', 'jimmy_base', 8],
    ['Bilincini kaybetmek', 'missfam5_blackout', 'pass_out', 8],
    ['Yıkanmak', 'missfam2_washing_face', 'michael_washing_face', 8],
    ['Boynunu ovmak', 'amb@world_human_cop_idles@female@idle_a', 'idle_c', 8],
    ['Avuçlarınızı birbirine sürtün', 'amb@world_human_cop_idles@female@idle_b', 'idle_d', 8],
    ['Ellerinizi birbirine sürtün', 'move_action@p_m_one@unarmed@idle@variations', 'idle_a', 8],
    ['İki parmağınızı gösterin', 'amb@code_human_in_car_mp_actions@v_sign@bodhi@rps@base', 'idle_a', 8],
    ['Etrafınıza bakın', 'amb@world_human_guard_patrol@male@idle_a', 'idle_b', 8],
    ['Kontrol edin', 'amb@medic@standing@kneel@enter', 'enter', 8],
    ['Dışarı bakmak', 'missmic4premiere', 'crowd_c_idle_01', 8],
    ['Araba ?', 'anim@mp_player_intcelebrationfemale@shush', 'shush', 8],
    ['Burnunu karıştırmak', 'anim@mp_player_intcelebrationfemale@nose_pick', 'nose_pick', 8],
    ['Düşünmek', 'amb@code_human_police_investigate@idle_a', 'idle_a', 8],
    ['Elde toplanıyor', 'amb@prop_human_movie_studio_light@idle_a', 'idle_a', 8],
    ['Ateşin yanında ısınmak', 'amb@world_human_stand_fire@male@base', 'base', 9],
    ['Duş almak', 'mp_safehouseshower@male@', 'male_shower_idle_d', 8],
    ['Cinsiyet (Erkek)', 'rcmpaparazzo_2', 'shag_action_a', 8],
    ['Cinsiyet (Kadın)', 'rcmpaparazzo_2', 'shag_action_poppy', 8],
  ],

  animPose: [
    ['Eller yukarı', 'anim@move_hostages@male', 'male_idle', 9],
    ['Ellerini başının arkasına koy.', 'anim@heists@ornate_bank@hostages@cashier_b@', 'flinch_loop_underfire', 8],
    ['Eller arkaya', 'anim@miss@low@fin@vagos@', 'idle_ped06', 8],
    ['Merhamet dileyin', 'amb@code_human_cower@male@react_cowering', 'base_front', 9],
    ['Oturun.-1', 'anim@miss@low@fin@lamar@', 'idle', 9],
    ['Oturun.-2', 'amb@medic@standing@tendtodead@enter', 'enter', 8],
    ['Oturun.-3', 'amb@medic@standing@kneel@base', 'base', 9],
    ['Yan yat', 'amb@world_human_bum_slumped@male@laying_on_right_side@base', 'base', 9],
    ['Karnınızın üzerine uzanın', 'amb@world_human_sunbathe@male@front@base', 'base', 9],
    ['Sırt üstü uzanın', 'missfbi1', 'cpr_pumpchest_idle', 9],
    ['Kelimeyi yaymak-1', 'missmic4premiere', 'wave_b', 8],
    ['Kelimeyi yaymak-2', 'amb@code_human_in_car_mp_actions@v_sign@std@rds@base', 'enter', 8],
    ['Başparmaklar yukarı', 'anim@mp_player_intcelebrationfemale@thumbs_up', 'thumbs_up', 8],
    ['Başparmak yukarı', 'anim@mp_player_intincarthumbs_upbodhi@ds@', 'enter_fp', 8],
    ['Kollarını çapraz yap-1', 'rcmme_amanda1', 'stand_loop_cop', 9],
    ['Kollarını çapraz yap-2', 'amb@world_human_cop_idles@female@idle_b', 'idle_e', 8],
    ['Eller yanlara', 'amb@code_human_police_investigate@base', 'base', 9],
    ['Koruma pozu', 'missfbi4mcs_2', 'loop_sec_b', 9],
    ['Kollarını iki yana açarak koşmak', 'amb@world_human_jog_standing@female@idle_a', 'idle_a', 8],
    ['Yerinde koşmak', 'amb@world_human_jog_standing@male@base', 'base', 8],
    ['Uzan-1', 'amb@world_human_muscle_flex@arms_at_side@idle_a', 'idle_a', 8],
    ['Uzan-2', 'timetable@tracy@ig_5@idle_b', 'idle_d', 8],
    ['Pazuları göster-1', 'amb@world_human_muscle_flex@arms_at_side@idle_a', 'idle_c', 8],
    ['Pazuları göster-2', 'amb@world_human_muscle_flex@arms_in_front@base', 'base', 8],
    ['Kollarınızı yanlara doğru açın', 'missfam5_yoga', 'c1_pose', 8],
    ['Kollarınızı ve bacaklarınızı birbirinden ayırın', 'missfam5_yoga', 'a2_pose', 8],
    ['Meditasyon-1', 'missfam5_yoga', 'f_yogapose_a', 8],
    ['Meditasyon-2', 'missfam5_yoga', 'c8_pose', 8],
    ['Meditasyon-3', 'missfam5_yoga', 'b4_fail_to_start', 8],
    ['Meditasyon-4', 'missfam5_yoga', 'start_to_c1', 8],
    ['Meditasyon-5', 'missfam5_yoga', 'start_to_a1', 8],
    ['Meditasyon-6', 'missfam5_yoga', 'a2_to_a3', 8],
    ['Meditasyon-7', 'missfam5_yoga', 'a3_fail_to_start', 8],
  ],

  animPositive: [
    ['Sevinmek-1', 'missmic_4premiere', 'movie_prem_01_f_a', 8],
    ['Sevinmek-2', 'mini@dartsoutro', 'darts_outro_03_guy2', 8],
    ['Sevinmek-3', 'mini@dartsoutro', 'darts_outro_01_guy1', 8],
    ['Sevinmek-4', 'anim@mp_player_intcelebrationfemale@freakout', 'freakout', 8],
    ['Ellerinizi çırpın-1', 'missmic_4premiere', 'movie_prem_02_f_a', 8],
    ['Ellerinizi çırpın-2', 'amb@world_human_cheering@female_d', 'base', 8],
    ['Ellerinizi çırpın-3', 'amb@world_human_cheering@male_a', 'base', 8],
    ['Ellerinizi çırpın-4', 'amb@world_human_cheering@male_e', 'base', 8],
    ['Ellerinizi çırpın-5', 'anim@mp_player_intcelebrationfemale@slow_clap', 'slow_clap', 8],
    ['Destek-1', 'amb@world_human_cheering@female_a', 'base', 8],
    ['Destek-2', 'amb@world_human_cheering@female_c', 'base', 8],
    ['Destek-3', 'amb@world_human_cheering@male_b', 'base', 8],
    ['Öpücük-1', 'anim@mp_player_intcelebrationfemale@blow_kiss', 'blow_kiss', 8],
    ['Öpücük-2', 'anim@mp_player_intcelebrationfemale@chin_brush', 'chin_brush', 8],
    ['Öpücük-3', 'anim@mp_player_intcelebrationfemale@finger_kiss', 'finger_kiss', 8],
    ['Sakin ol.', 'amb@code_human_police_crowd_control@idle_a', 'idle_c', 8],
    ['Saygı', 'anim@mp_player_intcelebrationfemale@bro_love', 'bro_love', 8],
  ],

  animNegative: [
    ['Yumruklarını ger-1', 'anim@mp_player_intcelebrationfemale@knuckle_crunch', 'knuckle_crunch', 8],
    ['Yumruklarını ger-2', 'anim@mp_player_intincarknuckle_crunchbodhi@ps@', 'idle_a_fp', 8],
    ['Hayal kırıklığına uğradım', 'mini@dartsoutro', 'darts_outro_03_guy1', 8],
    ['Suçlama', 'anim@mp_parachute_outro@female@lose', 'lose_loop', 8],
    ['Aptal', 'anim@mp_player_intcelebrationfemale@you_loco', 'you_loco', 8],
    ['Surat Asma', 'anim@mp_player_intcelebrationfemale@face_palm', 'face_palm', 8],
    ['Ateş et', 'amb@world_human_superhero@male@space_pistol@idle_a', 'idle_b', 8],
    ['Bir silahla', 'anim@deathmatch_intros@2hcombat_mgmale', 'intro_male_mg_c', 8],
    ['Bir sopayla', 'anim@deathmatch_intros@melee@2h', 'intro_male_melee_2h_b_gclub', 8],
    ['Dik durun-1', 'anim@deathmatch_intros@unarmed', 'intro_male_unarmed_c', 8],
    ['Dik durun-2', 'anim@deathmatch_intros@unarmed', 'intro_male_unarmed_a', 8],
    ['Dik durun-3', 'anim@deathmatch_intros@unarmed', 'intro_male_unarmed_b', 8],
    ['Dik durun-4', 'anim@deathmatch_intros@unarmed', 'intro_male_unarmed_d', 8],
  ],

  animDance: [
    ['DJ', 'anim@mp_player_intcelebrationfemale@dj', 'dj', 8],
    ['Dans-1', 'misschinese2_crystalmazemcs1_ig', 'dance_loop_tao', 9],
    ['Dans-2', 'mini@strip_club@lap_dance_2g@ld_2g_p2', 'ld_2g_p2_s1', 9],
    ['Dans-3', 'mini@strip_club@lap_dance_2g@ld_2g_p3', 'ld_2g_p3_s2', 9],
    ['Dans-4', 'amb@world_human_partying@female@partying_beer@idle_a', 'idle_b', 9],
    ['Dans-5', 'amb@world_human_prostitute@cokehead@idle_a', 'idle_a', 9],
    ['Dans-6', 'amb@world_human_prostitute@cokehead@idle_a', 'idle_c', 9],
    ['Dans-7', 'amb@world_human_jog_standing@female@base', 'base', 9],
    ['Dans-8', 'timetable@tracy@ig_8@idle_a', 'idle_a', 8],
    ['Dans-9', 'timetable@tracy@ig_5@idle_a', 'idle_a', 9],
    ['Dans-10', 'timetable@tracy@ig_5@idle_a', 'idle_b', 9],
    ['Dans-11', 'timetable@tracy@ig_5@idle_a', 'idle_c', 9],
    ['Dans-12', 'oddjobs@assassinate@multi@yachttarget@lapdance', 'yacht_ld_f', 8],
    ['Dans-13', 'mp_safehouse', 'lap_dance_girl', 8],
    ['Dans etmek', 'misscarsteal4@toilet', 'desperate_toilet_idle_a', 9],
    [
      'Tamamlayıcı dans 1',
    ...
    ['Uzatmalı dans 2', 'amb@code_human_in_car_mp_actions@dance@bodhi@ds@base', 'idle_a_fp', 9],
    ['Uzatmalı dans 3', 'amb@code_human_in_car_mp_actions@dance@bodhi@rds@base', 'idle_b', 9],
    ['Uzatmalı dans 4', 'amb@code_human_in_car_mp_actions@dance@std@ds@base', 'idle_a', 9],
    [
      'Uzatmalı dans 5',
    ...
    ['Uzatmalı dans 13', 'anim@amb@nightclub@mini@dance@dance_solo@male@var_a@', 'med_center_up', 9],
    ['Uzatmalı dans 14', 'anim@amb@nightclub@mini@dance@dance_solo@male@var_a@', 'med_right_up', 9],
    [
      'Uzatmalı dans 15',
    ...
    ['Uzatmalı dans 17', 'timetable@tracy@ig_5@idle_b', 'idle_e', 9],
    ['Uzatmalı dans 18', 'mini@strip_club@idles@dj@idle_04', 'idle_04', 9],
    [
      'Uzatmalı dans 19',
    ...
    ['Uzatmalı dans 20', 'special_ped@mountain_dancer@monologue_4@monologue_4a', 'mnt_dnc_verse', 9],
    ['Uzatmalı dans 21', 'special_ped@mountain_dancer@monologue_3@monologue_3a', 'mnt_dnc_buttwag', 9],
    [
      'Uzatmalı dans 22',
    ...
    ['Uzatmalı dans 27', 'misschinese2_crystalmazemcs1_cs', 'dance_loop_tao', 9],
    ['Uzatmalı dans 28', 'misschinese2_crystalmazemcs1_ig', 'dance_loop_tao', 9],
    ['Uzatmalı dans 29', 'anim@mp_player_intcelebrationfemale@uncle_disco', 'uncle_disco', 9],
    ['Uzatmalı dans 30', 'anim@mp_player_intcelebrationfemale@raise_the_roof', 'raise_the_roof', 9],
    ['Uzatmalı dans 31', 'anim@mp_player_intcelebrationmale@cats_cradle', 'cats_cradle', 9],
    ['Uzatmalı dans 32', 'anim@mp_player_intupperbanging_tunes', 'idle_a', 9],
    ['Uzatmalı dans 33', 'anim@amb@nightclub@mini@dance@dance_solo@female@var_a@', 'high_center', 9],
    ['Uzatmalı dans 34', 'anim@amb@nightclub@mini@dance@dance_solo@female@var_b@', 'high_center', 9],
    ['Uzatmalı dans 35', 'anim@amb@nightclub@mini@dance@dance_solo@male@var_b@', 'high_center', 9],
    [
      'Uzatmalı dans 36',
    ...
    ['Uzatmalı dans 40', 'anim@amb@nightclub@lazlow@hi_podium@', 'danceidle_hi_06_base_laz', 9],
    ['Uzatmalı dans 41', 'special_ped@zombie@monologue_4@monologue_4l', 'iamtheundead_11', 9],
  ],

  animRemain: [
    ['Seks-1', 'anim@mp_player_intcelebrationfemale@air_shagging', 'air_shagging', 8],
    ['Seks-2', 'anim@mp_player_intcelebrationfemale@dock', 'dock', 8],
    ['Tavuk', 'anim@mp_player_intcelebrationfemale@chicken_taunt', 'chicken_taunt', 8],
    ['Alay Etmek-1', 'anim@mp_player_intcelebrationfemale@jazz_hands', 'jazz_hands', 8],
    ['Alay Etmek-2', 'anim@mp_player_intcelebrationfemale@thumb_on_ears', 'thumb_on_ears', 8],
    ['Alay Etmek-3', 'anim@mp_player_intcelebrationmale@thumb_on_ears', 'thumb_on_ears', 8],
    ['Fotoğrafçı', 'anim@mp_player_intcelebrationfemale@photography', 'photography', 8],
    ['Kaya', 'amb@code_human_in_car_mp_actions@rock@bodhi@rps@base', 'idle_a', 8],
    ['Gitarist', 'anim@mp_player_intcelebrationfemale@air_guitar', 'air_guitar', 8],
    ['Ceset', 'anim@melee@machete@streamed_core@', 'victim_front_takedown', 8],
    ['Hurda', 'creatures@rottweiler@melee@', 'victim_takedown_from_front', 8],
    ['Yerinde koşu', 'amb@world_human_jog_standing@male@base', 'base', 8],
    ['Salıncak', 'anim@mp_player_intcelebrationmale@peace', 'peace', 9],
  ],
