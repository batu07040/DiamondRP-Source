...
export default class Inventory extends Component<{ test?: boolean }, InventoryMainData> {
              ...
              {owner_type == 1 && owner_id == this.state.myid
                ? this.state.blocks.map((inv) => {
                  return inv.owner_type > 0 && inv.owner_id != this.state.myid && !inv.closed ? (
                    ...
                    >Oyuncuya Ver
                      {inv.desc.indexOf('(') > 1 ? inv.desc.split('(')[0] : inv.desc}
                    </MenuItem> : ""
                  );
                })
                : ''}
  ...
  inventoryBlockDataChildren(
    ...
    return <div
      className={`inv-items ranec ${weight_max > 0 ? 'ranec-scroll-small' : 'ranec-scroll-equip'
        }`}
    >
      {closed ? (
        <></>
              ...
              <div className="darkbox-inv darkboxmiddle" id={`equip_block`}>
                ...
                <div className="inv-line-1">
                  {this.equipItemRender(
                    <div className="inv-item-wrap">
                      <div
                        className={`${this.state.equip.glasses ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                          }`}
                      >
                        <img src={glasses} alt="" />
                      </div>
                    ...
                    270,
                    this.state.equip.glasses, "Gözlük"
                  )}
                  {this.equipItemRender(
                    <div className="inv-item-wrap">
                      <div
                        className={`${this.state.equip.hat ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                          }`}
                      >
                        <img src={hat} alt="" />
                      </div>
                  ...
                  {this.equipItemRender(
                    <div className="inv-item-wrap">
                      <div
                        className={`${this.state.equip.ear ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                          }`}
                      >
                        <img src={jewelry} alt="" />
                      </div>
                ...
                <div className="inv-line-2">
                  {this.equipItemRender(
                    <div className="inv-item-wrap biggest">
                      <div
                        className={`${this.state.equip.torso ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                          }`}
                      >
                        <img src={shirt} alt="" />
                      </div>
                    ...
                    265,
                    this.state.equip.torso, "Govde"
                  )}
                  <div className="items-2">
                    {this.equipItemRender(
                      <div className="inv-item-wrap">
                        <div
                          className={`${this.state.equip.watch ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                            }`}
                        >
                          <img src={watch} alt="" />
                        </div>
                      ...
                      272,
                      this.state.equip.watch, "Akilli Saat"
                    )}
                    {this.equipItemRender(
                      <div className="inv-item-wrap">
                        <div
                          className={`${this.state.equip.bracelet ? `inv-item` : `inv-item-default`
                ...
                <div className="inv-line-2">
                  {this.equipItemRender(
                    <div className="inv-item-wrap biggest">
                      <div
                        className={`${this.state.equip.leg ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                          }`}
                      >
                        <img src={jeans} alt="" />
                      </div>
                  ...
                  <div className="items-2">
                    {this.equipItemRender(
                      <div className="inv-item-wrap">
                        <div
                          className={`${this.state.equip.accessorie ? `inv-item` : `inv-item-default`
                            } ${this.waitServer ? 'inventory-item-disabled' : ''}`}
                        >
                          <img src={tie} alt="" />
                        </div>
                      ...
                      268,
                      this.state.equip.accessorie, "Aksesuarlar"
                    )}
                    {this.equipItemRender(
                      <div className="inv-item-wrap">
                        <div
                          className={`${this.state.equip.mask ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                            }`}
                        >
                          <img src={mask} alt="" />
                        </div>
                ...
                <div className="inv-line-4">
                  {this.equipItemRender(
                    <div className="inv-item-wrap">
                      <div
                        className={`${this.state.equip.foot ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                          }`}
                      >
                        <img src={boots} alt="" />
                      </div>
                ...
                <div className="inv-line-2">
                  {this.state.equip.phone ? this.equipItemRender(
                    <div className="inv-item-wrap">
                      <div
                        className={`${this.state.equip.phone ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                          }`}
                      >
                        <img src={phone} alt="" />
                      </div>
                    ...
                    8,
                    this.state.equip.phone, "Telefon"
                  ) : ""}
                  {this.state.equip.clock ? this.equipItemRender(
                    <div className="inv-item-wrap">
                      <div
                        className={`${this.state.equip.clock ? `inv-item` : `inv-item-default`} ${this.waitServer ? 'inventory-item-disabled' : ''
                          }`}
                      >
                        <img src={clock} alt="" />
                      </div>
                  ...
                  {this.state.equip.tablet ? this.equipItemRender(
                    <div className="inv-item-wrap">
                      <div
                        className={`${this.state.equip.tablet ? `inv-item` : `inv-item-default`
                          } ${this.waitServer ? 'inventory-item-disabled' : ''}`}
                      >
                        <img src={tablet} alt="" />
                      </div>
                    ...
                    282,
                    this.state.equip.tablet, "Tablet"
                  ) : ""}
                </div>
                <br />
