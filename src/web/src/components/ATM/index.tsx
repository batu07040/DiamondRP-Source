        ...
        return <>
            ...
            <div className="b1-money">
                <div>
                    ...
                    <div className="b1-summ-info">Nakit</div>
                </div>
                <div>
                    <div className="b1-summ">${this.numberFormat(this.state.bank)}</div>
                    <div className="b1-summ-info">Hesap Bakiyesi</div>
                </div>
                <div>
                    <div className="b1-summ">{this.state.bank_number}</div>
                    <div className="b1-summ-info">Hesap Numarasi</div>
                </div>
                {/* <div>
            ...
            {this.state.page == "main" ? <div className="b2-buttons">
                <div className="b2-item" onClick={e => { mp.trigger('transferMoney')}}>Para Transferi</div>
                <div className="b2-item" onClick={e => { this.setPage('getCash')}}>Para Cekme</div>
                <div className="b2-item" onClick={e => { this.setPage('putCash') }}>Para Yatirma</div>
            ...
            {this.state.page == "getCash" ? <div className="b3">
                ...
                <div className="b3-vars">
                    ...
                    <div className="b2-item b3-item-done" onClick={e => { this.getCash()}}>ÇEK</div>
                </div>
            </div> : <></>}
            {this.state.page == "putCash" ? <div className="b3">
                ...
                <div className="b3-vars">
                    ...
                    <div className="b2-item b3-item-done" onClick={e => { this.putCash() }}>Yatir</div>
                </div>
            </div> : <></>}
