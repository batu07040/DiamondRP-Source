            ...
            <div className="row">
                    ...
                    {mafiaCarsConf.map((item: MafiaCar, id) => {
                        ...
                        return <div className="card-car hoverable" style={{
                            ...
                            <div className="card-image">
                                ...
                                <span className="card-title">Minibüs ile {item.name} <label className="grey-text text-lighten-3">(${item.cost})</label></span>
                        </div>
                    })}
                </div>
                <div className="col-lg-8">
                    ...
                    <div className="content">
                        <h2 style={{textAlign: "center"}}>İçerik</h2><br/>
                            ...
                            }}>Sipariş vermek (${this.getSelectedCar().cost})</button>
                    </div>
                    ...
                    </> : <h2 style={{ textAlign: "center" }}>Bir minibüs seçin</h2>}
                </div>
            </div>
        </div>);
    }
