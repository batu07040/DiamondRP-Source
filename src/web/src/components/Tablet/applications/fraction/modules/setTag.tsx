...
export default class SetTag extends Component<{tag:string}, {}>{
  ...
  render() {
    return (
      ...
      <h2 className="mini-title">ETİKETİ ayarla</h2>
      <div className="notepad-giveWantedBlock">
        <div>
          <input type="text" className="primary-input wide mb10" ref={this.id} maxLength={20} placeholder="Etiketi girin" defaultValue={this.props.tag}/>
        </div>
        <div></div>
        <div>
