      ...
      <div className="section-view">
        ...
        <div className="left-box-screen clothes">
          ...
          <div className="left-box-enter-list clothes all">
            <div className="clothes-item go-back active"><img src={require('../../../assets/images/arrow-left.svg')} alt="" />Cikis</div>
            <div className="clothes-list">
              <div className="clothes-item clth">
                <p>
                  Bir veya Iki sey<span>$234</span>
                </p>
            ...
            <div className="car-buy-box">
              <button className="primary-button large">Satin Al</button>
              <div>
                <p>Fiyat</p>
